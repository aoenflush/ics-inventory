                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            {{-- <img src="{{ URL::to('user.png') }}" class="user-image" alt="User Image"> --}}
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                {{-- <img src="{{ URL::to('user.png') }} " class="img-circle" alt="User Image"> --}}
...
@include('layouts.sidebar')
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <?php $date = date('Y')?>
        <strong>Copyright &copy; {{$date}} <a href="#">Rendra</a>.</strong> All rights reserved.
    </footer>
...
<!-- Bootstrap 3.3.7 -->
<script src="{{  URL::to('assets/bower_components/bootstrap/dist/js/bootstrap.min.js') }} "></script>
<!-- AdminLTE App -->
